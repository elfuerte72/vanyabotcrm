"""Common setup for RU funnel test scripts.
...
async def send_stage(stage: int, variant: str = "belly") -> None:
    """Set funnel_stage in DB and send the RU funnel message to test user."""
    configure_logging()
