"""Common setup for RU thighs funnel test scripts.

Usage: python scripts/thighs/stage_N.py  (from project root or any directory)
"""
...
async def send_stage(stage: int, variant: str = "thighs") -> None:
    """Set funnel_stage in DB and send the RU thighs funnel message to test user."""
    configure_logging()
