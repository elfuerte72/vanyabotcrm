"""Common setup for RU arms funnel test scripts.

Usage: python scripts/arms/stage_N.py  (from project root or any directory)
"""
...
async def send_stage(stage: int, variant: str = "arms") -> None:
    """Set funnel_stage in DB and send the RU arms funnel message to test user."""
    configure_logging()
